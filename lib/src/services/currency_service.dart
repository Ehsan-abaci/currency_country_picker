import 'package:currency_country_picker/src/constant/currencies.dart';
...
class CurrencyService {
  ...
  CurrencyService()
      : _currencies =
            currencies.map((currency) => Currency.fromJson(currency)).toList();
  ...
  Currency? findByCode(String? code) {
    ...
    return _currencies
        .where((currency) => currency.code == uppercaseCode)
        .firstOrNull;
  }
